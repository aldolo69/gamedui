...
this is the  display buffer. for easy of programming 0,0 origin is in the top left corner
0,0--->15,0
|
|
v
...
extern unsigned char displayPixelState(int x,int y);
...
#define _icon_slideshow 16
#define _icon_END_1 17
#define _icon_END_2 18
#define _icon_DEMO_1 19
#define _icon_DEMO_2 20
#define _icon_LIVES_1 21
#define _icon_LIVES_2 22
#define _icon_LEVEL_1 23
#define _icon_LEVEL_2 24
...
#define max_playfield 3
typedef struct xy{int x;int y;};
extern void displayPlayField(int playfield,xy *manXY,
                                           int gostMax,xy gostXY[],
                                           int starMax,xy starsXY[]);
