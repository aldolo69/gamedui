...
const char displayPlayfield0[] PROGMEM = "\
QQQQQQQQQQQQQQQQ\
Q@   *    *    Q\
Q QQQQQQQQQQQQ Q\
Q*    *  *    *Q\
...
Q    *    *    Q\
QQQQQQQQQQQQQQQQ";
const char displayPlayfield1[] PROGMEM = "\
QQQQQQQQQQQQQQQQ\
Q*     @      *Q\
Q QQQQ QQ QQQQ Q\
Q Q   *  *   Q Q\
...
const char displayPlayfield2[] PROGMEM = "\
QQQ QQQQQQQQ QQQ\
Q*   QQQQQQ   *Q\
Q QQ *    * QQ Q\
Q QQ QQQQQQ QQ Q\
...
const char displayPlayfield3[] PROGMEM = "\
QQQQQQQQQQQQQQQQ\
Q*  *  @   *  *Q\
Q QQQ QQQQ QQQ Q\
Q Q  *    *  Q Q\
...
const char *displayPlayfield[]
={displayPlayfield0,displayPlayfield1,displayPlayfield2,displayPlayfield3};

/*
-return the position of:runner,stars,ghosts.
-draw walls without player ghosts and stars
*/
void displayPlayField(int playfield,xy *manXY,
                      int ghostMax,xy ghostXY[],
                      int starMax,xy starXY[])
{
    char buffer[16];
    int iRow=0;
    int iCol=0;
    ...
    int iGhost=0;
const char *p;
    if(playfield>=max_playfield) return;
p=displayPlayfield[playfield];
    ...
    {
        memcpy_P((void *)buffer, (void *)(p + (iRow*16)), 16);
        for(iCol=0; iCol<16; iCol++)
        {
            switch(buffer[iCol])
            {
            case 'Q':
                displayPixel(iCol,iRow,_draw_set);
                break;
            case 'M':
                if(iGhost<ghostMax)
                {
                    ghostXY[iGhost].x=iCol;
                    ghostXY[iGhost].y=iRow;
                    iGhost++;
                }
                break;
            case '@':
